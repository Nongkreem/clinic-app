...
router.get('/available-slots', authenticateToken, authorizeRole(['patient', 'doctor']), appointmentController.getAvailableSlotsByDateAndService);
...
router.put('/:id/patient-cancel', authenticateToken, authorizeRole(['patient', 'nurse', 'head_nurse']), appointmentController.cancelPatientAppointment);
router.put('/:id/patient-complete', authenticateToken, authorizeRole(['patient']), appointmentController.completePatientAppointment);
